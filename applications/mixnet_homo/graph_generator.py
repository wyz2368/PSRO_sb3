...
class HOMOGraph():
    def __init__(self,
        ...
        self.stored_normal_nodes = np.copy(self.normal_nodes)
        self.stored_compromised_nodes = np.copy(self.compromised_nodes)
    ...
    def reset(self):
        self.normal_nodes = np.copy(self.stored_normal_nodes)
        self.compromised_nodes = np.copy(self.stored_compromised_nodes)
        self.open_nodes = 1 - self.normal_nodes - self.compromised_nodes
        self.att_deploy = np.zeros(self.num_layers)
        self.def_deploy = self.normal_nodes + self.compromised_nodes
        self.update_graph_state()
